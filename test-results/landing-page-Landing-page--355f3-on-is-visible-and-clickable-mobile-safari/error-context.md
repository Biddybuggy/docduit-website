...
- Name: landing-page.spec.ts >> Landing page [id] >> consult CTA button is visible and clickable
...
Call log:
  ...
  - waiting for locator('a[href*="consultation"], a[href*="under-maintenance"]').first()
    14 × locator resolved to <a href="/id/consultation" class="text-sm font-medium">Konsultasi</a>
