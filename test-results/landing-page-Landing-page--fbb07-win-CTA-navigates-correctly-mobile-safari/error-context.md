...
- Name: landing-page.spec.ts >> Landing page [en] >> financial twin CTA navigates correctly
...
Locator:  locator('a[href="/en/financial-twin-simulator"]').first()
Expected: visible
Received: hidden
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('a[href="/en/financial-twin-simulator"]').first()
    14 × locator resolved to <a class="text-sm font-medium" href="/en/financial-twin-simulator">Financial Twin</a>
