      ...
      <div className='mx-auto flex max-w-5xl flex-col gap-3 sm:flex-row sm:items-start sm:justify-between'>
        <div className='space-y-1'>
          <p className='text-sm text-gray-600'>
            Kami menggunakan cookie analitik (Google Analytics) untuk memahami cara
            pengguna berinteraksi dengan situs ini. Data tidak dijual ke pihak
            ketiga.{' '}
            <a
          ...
          <p className='text-xs text-gray-400'>
            We use analytics cookies (Google Analytics) to understand how users
            interact with this site. Data is never sold to third parties.{' '}
            <a
              href='/en/privacy-policy'
              className='font-medium text-slate-600 underline hover:text-slate-500'
            >
              Privacy Policy
            </a>
          </p>
